# EudaiLabs Operational Principles

## Principle 1: Decide with evidence or with explicit assumptions

What cannot be measured, must be substantiated. What cannot be substantiated, does not get executed.

* Every initiative defines its success criterion before it begins.
...
We design solutions based on how the client actually operates, not on assumptions or generic templates.

* We understand processes, constraints, culture, and objectives before proposing.
* We adapt the solution to the context, not the client to the solution.
...
* We name what went wrong without looking for someone to blame — we look for causes.
* Every significant failure deserves an honest retrospective: what happened, why, what we are changing.
...
What happens within the team must be findable afterward. Not capturing it is choosing to let it disappear.

* What matters must be findable afterward, by whoever was not there.
